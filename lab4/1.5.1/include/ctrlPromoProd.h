...
class CtrlPromoProd: public IPromoProd {
    private:
        ...
        // tipo de contenedor para enviosPendientes
        // set<CompraProducto*>
    ...
    public:
        ...
        //Enviar Producto
        bool hayEnviosPendientes();
        vector<string> getVendedoresConEnviosPendientes();
        vector<string> getProductosConEnviosPendientesDeVendedor(string);
        vector<DataEnvioPendiente> getSolicitudesDeEnviosParaProducto(string, string);
        void marcarComoEnviado(string, string, string, string);
