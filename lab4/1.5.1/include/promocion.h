...
class Promocion {
    ...
    public:
        ...
        vector<string> infoProductos(); //Requerida por CtrlPromoProd para Consultar Promocion
        bool cumpleRequisitos(vector<DataPromoProducto>); //Requerida por CtrlPromoProd para Realizar Compra
};
