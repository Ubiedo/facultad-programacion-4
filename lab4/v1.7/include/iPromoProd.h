...
class IPromoProd {
    public:
        ...
        //Enviar Producto
        virtual bool noHayEnviosPendientes() = 0;
        virtual vector<string> getVendedoresConEnviosPendientes() = 0;
        virtual set<string> getProductosConEnviosPendientesDeVendedor(string) = 0;
        virtual vector<DataEnvioPendiente> getSolicitudesDeEnviosParaProducto(string, string) = 0;
        virtual void marcarComoEnviado(string, string, string) = 0;
};
